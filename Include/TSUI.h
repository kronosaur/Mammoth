...
enum EImageLibrary
	...
	imageUpIcon =					11,
	imageDownIcon =					12,
	imageSmallCloseIcon =			13,
	imageSmallOKIcon =				14,
	imageSmallLeftIcon =			15,
	imageSmallRightIcon =			16,
	imageSmallUpIcon =				17,
	imageSmallDownIcon =			18,
	imageSlotIcon =					19,
	imageSmallSlotIcon =			20,
	imageHumanMale =				21,
	imageHumanFemale =				22,
	imageSmallHumanMale =			23,
	imageSmallHumanFemale =			24,
	imageSmallEditIcon =			25,
	imagePlayIcon =					26,
	imageDebugIcon =				27,
	imageSettingsIcon =				28,
